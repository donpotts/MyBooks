$(function () {
    ...
    var dataTable = $('#AuthorsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(myBooks.authors.author.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                        items:
                            [
                                {
                                    text: l('Edit'),
                                    visible: abp.auth.isGranted('MyBooks.Authors.Edit'), //CHECK for the PERMISSION
                                ...
                                {
                                    text: l('Delete'),
                                    visible: abp.auth.isGranted('MyBooks.Authors.Delete'), //CHECK for the PERMISSION
                                    confirmMessage: function (data) {
                                        return l('AuthorDeletionConfirmationMessage');
                                    },
                                    action: function (data) {
                                        myBooks.authors.author
