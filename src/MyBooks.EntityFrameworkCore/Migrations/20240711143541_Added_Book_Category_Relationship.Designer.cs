...
namespace MyBooks.Migrations
{
    ...
    [Migration("20240711143541_Added_Book_Category_Relationship")]
    partial class Added_Book_Category_Relationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBooks.Authors.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MyBooks.Books.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyBooks.Books.BookAuthor", b =>
                {
                    ...
                    b.ToTable("AppBookAuthors", (string)null);
                });

            modelBuilder.Entity("MyBooks.Books.BookCategory", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyBooks.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyBooks.Books.BookAuthor", b =>
                {
                    b.HasOne("MyBooks.Authors.Author", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyBooks.Books.Book", "Book")
            ...
            modelBuilder.Entity("MyBooks.Books.BookCategory", b =>
                {
                    ...
                    b.HasOne("MyBooks.Categories.Category", "Category")
                        .WithMany()
